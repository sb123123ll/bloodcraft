...
public class ItemLingeringBloodBottle extends Item {

    public ItemLingeringBloodBottle() {
        this.setMaxStackSize(1);
        this.setUnlocalizedName("lingering_blood_bottle");
        this.setRegistryName(BloodMod.MODID, "lingering_blood_bottle");
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntitySplashBlood entitysplash = new EntitySplashBlood(worldIn, playerIn, true);
