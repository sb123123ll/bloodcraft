...
public class WorldGenBigBloodTree extends WorldGenAbstractTree {
    private Random rand;
    private World world;
    ...
    public WorldGenBigBloodTree(boolean notify) {
        super(notify);
    }
    ...
    void generateLeafNode(BlockPos pos) {
        for (int i = 0; i < this.leafDistanceLimit; ++i) {
            this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.BLOOD_LEAVES.getDefaultState());
        }
    }
    ...
    void limb(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_) {
        ...
        for (int j = 0; j <= i; ++j) {
            ...
            EnumFacing.Axis axis = this.getLogAxis(p_175937_1_, blockpos1);
            this.setBlockAndNotifyAdequately(this.world, blockpos1, p_175937_3_.getDefaultState().withProperty(BlockRotatedPillar.AXIS, axis));
        }
    }
    ...
    void generateTrunk() {
        ...
        Block block = ModBlocks.BLOOD_LOG;
    ...
    void generateLeafNodeBases() {
        for (FoliageCoordinates coords : this.foliageCoords) {
            ...
            if (!blockpos.equals(coords) && this.leafNodeNeedsBase(i - this.basePos.getY())) {
                this.limb(blockpos, coords, ModBlocks.BLOOD_LOG);
            }
        }
    }
    ...
    private boolean validTreeLocation() {
        ...
        boolean isSoil = state.getBlock() == ModBlocks.FLESH_CHUNK || 
    ...
    static class FoliageCoordinates extends BlockPos {
        ...
        public FoliageCoordinates(BlockPos pos, int branchBaseIn) {
            super(pos.getX(), pos.getY(), pos.getZ());
            this.branchBase = branchBaseIn;
        }
